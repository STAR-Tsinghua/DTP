...
ax.set_ylabel('reorder events number',size='xx-large')
ax.legend(fontsize='xx-large')
ax.set_xticks(x)
plt.xticks(size='xx-large')
plt.yticks(size='xx-large')
plt.gca().invert_xaxis()
plt.savefig('reorder_event.png',bbox_inches='tight') # 核心是设置成tight
