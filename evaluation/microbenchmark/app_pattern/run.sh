...
# server begin
# cd ~/Documents/DTP/evaluation/microbenchmark/commen_scripts;
./server_begin.sh $result_log $server_log;
# cd -
sleep 1
...
echo './client_trace 192.168.10.2 5555 $config $priority_weight $min_piriority &> $client_log'
./client_trace 192.168.10.2 5555 $config $priority_weight $min_piriority &> $client_log
# QUIC
